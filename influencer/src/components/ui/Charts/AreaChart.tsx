	...
	if (active && payload && payload.length) {
		return (
			<div
				className={cx(
					// base
					'rounded-xl border p-4 flex flex-col gap-3 text-sm shadow-2xl',
					// border color
					'border-gray-600/15 dark:border-gray-800',
					// background color
					'bg-white dark:bg-gray-950'
				)}
			>
				<div className={cx('')}>
					<p
						className={cx(
							...
							'font-medium',
							// text color
							'text-paragraph dark:text-gray-50'
						)}
					>
						{label}
					</p>
				...
				<div className={cx('space-y-0 ')}>
					{payload.map(({ value, category, color }, index) => (
						...
						>
							<span className="h-2 bg-primary w-2 rounded-full"></span>
							<p
								className={cx(
									// base
									'whitespace-nowrap text-right font-medium tabular-nums',
									// text color
									'text-secondary GilroyBold text-3xl dark:text-gray-50'
								)}
							>
