...
export default function ConversationCard({
	...
	return (
		<Link
			...
			className={cn(
				'text-left p-3 py-2.5 flex w-full gap-3 items-center hover:bg-neutral-100 transition-all',
		...
		>
			<div className="relative">
				<div className="rounded-full border border-gray-600/10 shadow-sm">
					<Avatar className={cn('size-9 border-2 border-white')}>
						<AvatarImage src={conversation.brand.iconURL} />
						<AvatarFallback />
					</Avatar>
				</div>
				<img
			...
			<div className="hidden lg:flex flex-col gap-0.5 w-full">
				...
				<div className="flex items-center gap-2">
					{conversation.lastMessage ? (
						<p className="text-neutral-700 text-xs font-base line-clamp-1">
