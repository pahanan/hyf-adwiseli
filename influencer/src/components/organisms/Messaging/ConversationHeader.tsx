	...
	return (
		<div className="h-[65px] px-4 bg-white border-b flex items-center gap-2.5">
			...
			<div className="flex flex-col">
				<p className="font-medium hover:text-primary transition-all cursor-pointer">
					{brand.name}
				</p>
			</div>
		</div>
