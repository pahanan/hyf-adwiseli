			...
			<div className={cn('group flex flex-col gap-1.5', className)}>
				...
				<div className="flex  items-center">
					...
					<input
						type={type}
						className={cn(
							'text-gray-600 font-normal text-sm bg-white flex py-5 px-4 rounded-md h-10 w-full border border-gray-200 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-400 disabled:cursor-not-allowed disabled:opacity-50 outline-none focus-visible:ring-2 ring-primary',
							error && 'ring-rose-500',
							inputClassName,
